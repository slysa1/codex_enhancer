...
6. Separate confirmed findings from hypotheses that need more evidence. Keep low-confidence items under hypotheses.
7. Include useful non-issues checked and dismissed when they prevent repeated investigation.
8. Produce these sections:
   - Executive Summary
   - System Map
