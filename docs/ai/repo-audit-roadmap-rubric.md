...
## Purpose
Use this rubric to turn full-repository audit findings into a prioritized roadmap. The roadmap should help a maintainer choose the next change without pretending every finding belongs in one implementation pass.
