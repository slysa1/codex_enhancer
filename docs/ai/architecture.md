...
9. [install_enhancer.bat](../../install_enhancer.bat) and [scripts/install_enhancer_web_gui.py](../../scripts/install_enhancer_web_gui.py): Windows-first local browser installer entrypoint for manual repo path entry, overwrite review, pack management, upgrade/reconcile, and guided install or managed-output refresh flow. [scripts/install_enhancer_gui.py](../../scripts/install_enhancer_gui.py) remains the legacy Tkinter wrapper and shared preview/completion helper surface.
